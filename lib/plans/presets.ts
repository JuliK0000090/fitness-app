...
export const GOAL_PRESETS: GoalPreset[] = [
  ...
  {
    slug: "glp1_muscle_defense",
    title: "GLP-1 muscle defense",
    category: "health",
    matches: ["glp-1", "glp1", "semaglutide", "tirzepatide", "ozempic", "wegovy", "mounjaro", "liraglutide", "muscle while losing", "preserve muscle"],
    defaultHabits: [
      { title: "Protein target — hit daily goal", cadence: "daily", icon: "Beef", pointsOnComplete: 20 },
      { title: "2.5 L water + electrolytes", cadence: "daily", icon: "Droplets", pointsOnComplete: 15 },
      { title: "Weekly weigh-in", cadence: "weekly_n", targetPerWeek: 1, icon: "Activity" },
    ],
    defaultWorkouts: [
      { workoutTypeName: "Strength Training", timesPerWeek: 3, duration: 50, icon: "Dumbbell" },
      { workoutTypeName: "Reformer Pilates", timesPerWeek: 2, duration: 50, icon: "Activity" },
      { workoutTypeName: "Walking", timesPerWeek: 5, duration: 30, icon: "Footprints" },
    ],
    defaultMeasurements: ["weight_kg", "body_fat_pct", "waist_cm"],
    suggestedDeadlineWeeks: 16,
  },
  {
    ...
    defaultWorkouts: [
      ...
      { workoutTypeName: "Mobility", timesPerWeek: 2, duration: 30, icon: "Activity" },
    ],
  ...
  },
  {
    ...
    title: "Dancer body",
    category: "aesthetic",
    matches: ["ballet", "dancer", "ballerina", "barre", "graceful", "dance"],
    defaultHabits: [
  ...
  },
  {
    ...
    category: "performance",
    matches: ["runner", "running", "5k", "10k", "run faster", "cardio fitness"],
    defaultHabits: [
