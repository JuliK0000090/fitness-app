  ...
  return (
    <div className="max-w-lg mx-auto py-4 px-4 space-y-4">
      ...
      <div className="glass rounded-2xl p-6 text-center fu2">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#A78BFA] to-[#22D3EE] flex items-center justify-center mx-auto mb-3">
      ...
      <div className="glass rounded-2xl p-4 fu2">
        ...
        <div className="space-y-2">
          {[
            { icon: Zap, color: "#A78BFA", label: "Workouts logged", count: workoutCount, xpEach: 25 },
            { icon: Scale, color: "#22D3EE", label: "Measurements logged", count: measurementCount, xpEach: 10 },
            { icon: Target, color: "#34D399", label: "Goals achieved", count: goalAchieved, xpEach: 150 },
            ...
            <div key={label} className="flex items-center gap-3">
              ...
              <p className="text-sm font-bold" style={{ color }}>{count * xpEach}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {workoutStreak && (
        <div className="glass rounded-2xl p-4 fu2">
          ...
          <div className="flex items-end gap-2">
            <p className="text-4xl font-black text-[#F472B6]">{workoutStreak.current}</p>
            <div className="pb-1">
          ...
          <div className="space-y-2">
            {achievements.map((a) => (
              <div key={a.id} className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#FBBF24]/20 flex items-center justify-center shrink-0">
                ...
                <p className="text-xs text-[#FBBF24] font-semibold">+{a.xpAwarded}</p>
              </div>
            ))}
          </div>
        </div>
